        ...
        <div class="row align-items-center">
          ...
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
                ...
                if ($_SESSION['logged']){
                echo '
                <li style="display: inline-block; border-right: 1px dotted black; padding-right: 10px;"><a href="#"><i class="fa fa-user"></i><b> Logged In User: <span style="color:red;">'.$_SESSION['logged'].'</span></b></a></li>
                <li style="display: inline-block; border-right: 1px dotted purple; padding-right: 10px; padding-left:10px;"><a href="yourcases.php"><i class="fa fa-user"></i><b style="color: magenta;"> YOUR CASES</b></a></li>
                <li style="display: inline-block; border-right: 1px dotted purple; padding-right: 10px; padding-left:10px;"><a href="casform.php"><i class="fa fa-user"></i><b style="color: brown;"> CHOOSE CAS</b></a></li>
