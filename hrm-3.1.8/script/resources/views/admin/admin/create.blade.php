    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                {!! Form::open(array('class'=>'form-horizontal form-bordered','method'=>'POST', 'id' => 'admin_store_form')) !!}
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="name" placeholder="Name" value="{{ \Illuminate\Support\Facades\Input::old('name') }}">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="email" placeholder="Email" value="{{ \Illuminate\Support\Facades\Input::old('email') }}">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="password" class="form-control" name="password" placeholder="password" value="{{ \Illuminate\Support\Facades\Input::old('email') }}">
                        </div>
                    </div>
